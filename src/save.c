...
extern HWND hWnd;/* windows */

void save_game()
{
	char fname[/*64*/MAX_PATH];
/*
#ifdef JAPAN
	...
	/* windows */
	fname[0]=0;
	if(SaveFileDialog(hWnd,fname,"","セーブデータを保存","Save Data(*.sav)\0*.sav\0All Files(*.*)\0*.*\0","sav")) return;
...
void read_pack(pack, fp, is_rogue)
object *pack;
FILE *fp;
boolean is_rogue;
{
