...
void mon_hit(monster, other, flame)
...
void rogue_hit(monster, force_hit)
register object *monster;
boolean force_hit;
{
	short damage, hit_chance;
...
boolean mon_damage(monster, damage)
object *monster;
short damage;
{
	char *mn;
...
void get_dir_rc(dir, row, col, allow_off_screen)
short dir;
short *row, *col;
...
short get_weapon_damage(weapon)
object *weapon;
{
	short damage;
