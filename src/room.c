...
short get_dungeon_char(row, col)
...
void dr_course(monster, entering, row, col)
object *monster;
boolean entering;
short row, col;
{
...
boolean get_oth_room(rn, row, col)
short rn, *row, *col;
{
	short d = -1;
